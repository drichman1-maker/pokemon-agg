...
const sampleFeatured = [
  { name: 'Charizard', set: 'Base Set', avg_price: 2900, price_change: 15.2, image_url: 'https://assets.pokemontcg.io/base1/4h.png' },
  { name: 'Pikachu', set: 'Base Set', avg_price: 245, price_change: 8.1, image_url: 'https://assets.pokemontcg.io/base1/25.png' },
  { name: 'Mewtwo', set: 'Base Set', avg_price: 1200, price_change: -3.4, image_url: 'https://assets.pokemontcg.io/base1/96.png' },
  { name: 'Blastoise', set: 'Base Set', avg_price: 880, price_change: 5.7, image_url: 'https://assets.pokemontcg.io/base1/9.png' },
  { name: 'Venusaur', set: 'Base Set', avg_price: 714, price_change: 2.3, image_url: 'https://assets.pokemontcg.io/base1/3.png' },
  { name: 'Gyarados', set: 'Base Set', avg_price: 490, price_change: -1.2, image_url: 'https://assets.pokemontcg.io/base1/130.png' },
];
